    ...
    return(
        <div className="flex flex-row justify-evenly">
            <div className="card">
                ...
                <button className="bg-blue-500 mt-2 hover:bg-blue-700 text-white py-2 px-4 rounded object-contain">Machinery</button>
            </div>
            <div className="card">
                ...
                <button className="bg-green-500 hover:bg-green-700 text-white mt-8 py-2 px-4 rounded ">Consultant</button>
            </div>
        </div>
    )
}
